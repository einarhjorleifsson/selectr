...
```{r, eval=FALSE}
require(devtools)
install_github("einarhjorleifsson/selectr")
```
...
fit=NetFit(haddock,c(0,130),c(-10,0.3,0),rtype="tt.logistic")
Estimates(fit)
Summary(fit)
...
fit=NetFit(holt,Meshsize,c(60,4),rtype="norm.loc",rel.power=pwr)
Estimates(fit); Summary(fit); PlotCurves(fit,plotlens=seq(40,90,0.1))

fit=NetFit(holt,Meshsize,c(60,4),rtype="norm.sca",rel.power=pwr)
Estimates(fit); Summary(fit); PlotCurves(fit,plotlens=seq(40,90,0.1))

#fit=NetFit(holt,Meshsize,c(4,0.1),rtype="gamma") #Gamma not yet implemented

fit=NetFit(holt,Meshsize,c(4,0.1),rtype="lognorm",rel.power=pwr)
Estimates(fit); Summary(fit); PlotCurves(fit,plotlens=seq(40,90,0.1))

fit=NetFit(holt,Meshsize,c(55,4,65,4,2),rtype="binorm.sca",rel.power=pwr)
Estimates(fit); Summary(fit); PlotCurves(fit,plotlens=seq(40,90,0.1))

fit=NetFit(holt,Meshsize,c(4,0.2,4.2,0.1,2),rtype="bilognorm",rel.power=pwr)
Estimates(fit); Summary(fit); PlotCurves(fit,plotlens=seq(40,90,0.1))
...
#trammel=read.table("trammel.dat",head=F); 
...
fit=NetFit(trammel,Meshsize,c(25,4),rtype="norm.loc",rel.power=pwr)
Estimates(fit); Summary(fit); PlotCurves(fit,plotlens=seq(10,40,0.1))

fit=NetFit(trammel,Meshsize,c(25,4),rtype="norm.sca",rel.power=pwr)
Estimates(fit); Summary(fit); PlotCurves(fit,plotlens=seq(10,40,0.1))

#fit=NetFit(trammel,Meshsize,c(3,0.1),rtype="gamma") #Gamma not yet implemented

fit=NetFit(trammel,Meshsize,c(3,0.1),rtype="lognorm",rel.power=pwr)
Estimates(fit); Summary(fit); PlotCurves(fit,plotlens=seq(10,40,0.1))

fit=NetFit(trammel,Meshsize,c(18,4,30,4,2),rtype="binorm.sca",rel.power=pwr)
Estimates(fit); Summary(fit); PlotCurves(fit,plotlens=seq(10,40,0.1))

fit=NetFit(trammel,Meshsize,c(3,0.2,3.2,0.1,2),rtype="bilognorm",rel.power=pwr)
Estimates(fit); Summary(fit); PlotCurves(fit,plotlens=seq(10,40,0.1))
